...
LubeLogger does not require authentication by default; however, it is highly recommend that you set up authentication if your LubeLogger instance is accessible via the Internet or if you wish to invite other users to your instance.
...
![alt text](images/1773776326532-image.png)
...
![alt text](images/1773777388961-image.png)
...
![alt text](images/1773777677656-image.png)

Once all the fields are filled out, click "Register" and their user will be created.

If the Register link is not visible on the login page, it is because the registration is disabled in the Server Settings Configurator.

![alt text](images/1773777711552-image.png)
